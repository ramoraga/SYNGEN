...
for iteration in range(1, 2):
    ...
    for x_index, x_angle in enumerate(x_angles, start=1):
        for z_index, z_angle in enumerate(z_angles, start=1):
            ...
            # Specify output path
            main_output_path = f"C:/Users/dinob/Desktop/CAD Project/Prismatic Geometries/null_{iteration+5}{x_index}{z_index}"
            mask_output_path = f"null_m{iteration+5}{x_index}{z_index}"
